...
@section('title', 'Contact App | Company' . $company->first_name)
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row mb-0">
                                        <div class="col-md-9 offset-md-3">
                                            <a href=" {{ route('admin.companies.edit', $company->id) }}" class="btn btn-info">Edit</a>
                                            @include('shared.buttons.destroy', [
                                                'action' => route('admin.companies.destroy', ['company' => $company->id, 'redirect' => 'admin.companies.index']),
                                                'buttonStyle' => 'default'
                                            ])
